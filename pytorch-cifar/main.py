...
transform_train = transforms.Compose([
    ...
    transforms.ToTensor(),
    # Normalize image
    # transforms.Normalize(mean=[113.9, 123.0, 125.3], std=[66.7, 62.1, 63.0]),
    transforms.Normalize(mean=[x / 255 for x in [113.9, 123.0, 125.3]], std=[x / 255 for x in [66.7, 62.1, 63.0]]),
